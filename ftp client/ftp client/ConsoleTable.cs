...
namespace ftp_client
{
    class ConsoleTable
    {
        ...
        public void Write(Format format = ftp_client.Format.Default)
        {
            switch (format)
            {
                case ftp_client.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case ftp_client.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case ftp_client.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case ftp_client.Format.Minimal:
